        ...
        return (
            <div className="space-y-6 text-center animate-in fade-in zoom-in duration-300 py-8">
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center">
                    <h3 className="text-green-800 font-bold text-xl mb-1">{t.contact.form.success.title}</h3>
                    <p className="text-green-700 mb-6">{t.contact.form.success.body}</p>
                </div>

                {siteConfig.whatsappNumber && (
                    <div className="pt-2">
                        <p className="text-muted-foreground mb-3 text-sm">
                            {t.contact.form.success.whatsappPrompt}
                        </p>
                        <a
                            href={whatsappLink}
                            target="_blank"
