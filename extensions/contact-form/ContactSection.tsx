        ...
        <Section id="contacto">
            <Container>
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
                    {/* Contact Info */}
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight mb-6 font-heading">¿Listo para Conseguir Más Clientes?</h2>
                        <p className="text-muted-foreground text-lg mb-8">
                            Escribinos por WhatsApp y te asesoramos sin compromiso. Te respondemos en menos de 1 hora durante horario laboral.
                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-foreground">WhatsApp / Teléfono</h3>
